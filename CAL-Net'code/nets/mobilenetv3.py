...
def MobileNetV3(inputs, alpha=1.0, kernel=5, se_ratio=0.25):
    ...
    # 26,26,112 -> 13,13,160
    x = _bneck(x, 6, 112, alpha, kernel, 2, se_ratio, 'hardswish', 12)
    x = _bneck(x, 6, 112, alpha, kernel, 1, se_ratio, 'hardswish', 13)
    x = _bneck(x, 6, 112, alpha, kernel, 1, se_ratio, 'hardswish', 14)
    feat5 = x
